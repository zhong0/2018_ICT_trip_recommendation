...
* ### Android Studio
  ...
  >Notification: Our project only provides to academic needs. If you need to download the user interface file, please feel free to contact us via the e-mail to 109753106@g.nccu.edu.tw. We would authorize the access after an assessment.
